 ...
 * </p>
 * <p>
 * Throughout, the {@link selenium.pagefactory.framework.config.TimeoutType} enum is used.
...
public interface SeleniumActions {
     ...
     *
     * @throws BiziboxWebDriverException - if the element isn't clickable when this method is called.
     */
    WebElement clickNoWait(By locator) throws BiziboxWebDriverException;
