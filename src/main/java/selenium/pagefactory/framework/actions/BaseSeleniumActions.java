...
import selenium.pagefactory.framework.exception.SeleniumActionsException;
...
public abstract class BaseSeleniumActions<B extends Browser> implements SeleniumActions {
    ...
    protected static final Logger LOGGER = Logger.getLogger(BaseSeleniumActions.class);
    ...
    public void clickAndVerifyNotPresent(By locatorToClick, By locatorToVerifyNotPresent, TimeoutType timeout) {
        ...
        LOGGER.info("After click, waiting for '" + locatorToVerifyNotPresent + "' to NOT be present.");
    ...
    public void clickAndVerifyNotVisible(By locatorToClick, By locatorToVerifyNotVisible, TimeoutType timeout) {
        click(locatorToClick, timeout);
        LOGGER.info("After click, waiting for '" + locatorToVerifyNotVisible + "' to NOT be visible.");
    ...
    public WebElement clickAndVerifyPresent(By locatorToClick, By locatorToVerifyPresent, TimeoutType timeout) {
        click(locatorToClick, timeout);
        LOGGER.info("After click, waiting for '" + locatorToVerifyPresent + "' to be present.");
        int waitSeconds = getTimeout(timeoutsConfig.getWebElementPresenceTimeoutSeconds(), timeout);
    ...
    public WebElement clickAndVerifyVisible(By locatorToClick, By locatorToVerifyVisible, TimeoutType timeout) {
        click(locatorToClick, timeout);
        LOGGER.info("After click, waiting for '" + locatorToVerifyVisible + "' to be visible.");
    ...
    @Override
    public WebElement clickNoWait(By locator) throws BiziboxWebDriverException {
        WebElement el = getElement(locator);
        if (!isClickable(el)) {
            throw new BiziboxWebDriverException("Element is not clickable: " + locator.toString());
        }
        el.click();
        LOGGER.info("Clicked element with locator '" + locator + "', no waiting.");
        return el;
    }
        ...
        for (WebElement el : matches) {
            try {
                if (containsText(el, text, caseSensitive)) {
                    LOGGER.info("SUCCESS: Found web element containing text '" + text + "' with locator '" + locator + "'");
                    return el;
                }
            } catch (Exception e) { //Don't fail just because one web element was stale. Continue searching for the text.
                LOGGER.debug("Exception while searching for web elements containing text '" + text + "' with locator '" + locator + "'");
    ...
    public WebElement findElementContainingTextWithRefresh(final By locator, final String text, boolean caseSensitive, TimeoutType timeout) {
        ...
        LOGGER.info("Waiting for element containing text '" + text + "' defined by locator '" + locator + "', timeout of " + waitSeconds + " seconds");
        try {
            ...
            LOGGER.info("Success finding element containing text '" + text + "' defined by locator '" + locator + "'!");
            return found;
        } catch (TimeoutException e) {
            LOGGER.error("Timeout waiting to find text '" + text + "' in an element matching locator '" + locator + "'");
            ...
            try {
                if (containsText(el, text, caseSensitive) && el.isDisplayed()) {
                    if (Strings.isNullOrEmpty(text)) {
                        ...
                        LOGGER.info("SUCCESS: Found visible element containing text '" + text + "' located by '" + locator + "'");
                    }
                    return el;
                }
            } catch (Exception e) { //Don't fail just because one web element was stale. Continue searching for the text.
                if (Strings.isNullOrEmpty(text)) {
                    ...
                    LOGGER.debug("Exception while searching for visible elements containing text '" + text + "' located by '" + locator + "'");
                }
                LOGGER.debug(Throwables.getStackTraceAsString(e));
            }
        }
    ...
    /**
     * Return the {@link selenium.pagefactory.framework.browser.Browser} object this actions class is tied to.
     */
    @Override
    public B getBrowser() {
        return browser;
    ...
    public WebElement inputText(By locator, String text) {
        LOGGER.info("Inputting text '" + text + "' into element with locator '" + locator + "'");
    ...
    public WebElement inputText(@Nonnull WebElement el, String text) {
        LOGGER.info("Inputting text '" + text + "' into web element <" + el.getTagName() + ">");
        try {
            el.sendKeys(text);
        } catch (Exception e) {
    ...
    public WebElement inputTextSlowly(By locator, String text) {
        WebElement el = getElementWithWait(locator);
        LOGGER.info("Inputting text '" + text + "' into web element with locator '" + locator + "'");
        return inputTextSlowly(el, text);
    }

    @Override
    public WebElement inputTextSlowly(@Nonnull WebElement el, String text) {
        LOGGER.info("Inputting text '" + text + "' slowly into web element " + el.getTagName());
    ...
    public void verifyElementContainsText(final By locator, final String text, TimeoutType timeout) {
        ...
        LOGGER.info("SUCCESS: Verified element with Locator '" + locator + "' contains text '" + text + "'");
    }
    ...
    public void verifyElementNotPresented(By locator, TimeoutType timeout) {
        ...
        LOGGER.trace("SUCCESS: Verified element with locator '" + locator + "' is NOT present");
    }
    ...
    public WebElement verifyElementNotSelected(By locator, TimeoutType timeout) {
        ...
        LOGGER.info("SUCCESS: Verified element with locator '" + locator + "' is NOT selected");
    ...
    public WebElement verifyElementNotSelected(WebElement el, TimeoutType timeout) {
        ...
        LOGGER.info("SUCCESS: Verified element <" + el.getTagName() + "> is NOT selected");
        return el;
    }
    ...
    public WebElement verifyElementPresented(By locator, TimeoutType timeout) {
        ...
        LOGGER.trace("SUCCESS: Verified element with Locator '" + locator.toString() + "' is present");
        return el;
    }
    ...
    public void verifyElementRemoved(WebElement element, TimeoutType timeout) {
        int waitSeconds = getTimeout(timeoutsConfig.getWebElementPresenceTimeoutSeconds(), timeout);
        LOGGER.info("Waiting for element to become stale (removed from the DOM) using timeout of " + waitSeconds + " seconds");
    ...
    public WebElement verifyElementSelected(WebElement el, TimeoutType timeout) {
        ...
        LOGGER.info("SUCCESS: Verified element <" + el.getTagName() + "> is selected");
        return el;
    }
    ...
    public WebElement verifyPageRefreshed(WebElement elementFromBeforeRefresh, By locatorAfterRefresh, TimeoutType timeout) {
        ...
        LOGGER.info("Waiting for locator '" + locatorAfterRefresh + "' to be present after page refreshes, using timeout of " + waitSeconds + " seconds");
    ...
    public void waitForJavascriptSymbolToBeDefined(final String symbol, TimeoutType timeout) {
        ...
        LOGGER.info("Success verifying javascript symbol '" + symbol + "' is defined!");
    }
    ...
    public void waitForJavascriptSymbolToHaveValue(final String symbol, final String value, TimeoutType timeout) {
        ...
        LOGGER.info("Success verifying javascript symbol '" + symbol + "' has value '" + value + "'!");
    }
    ...
    public <T> T waitOnExpectedCondition(ExpectedCondition<T> expectedCondition, String message, TimeoutType timeout) {
        ...
        wait.withMessage(message)
            .ignoring(StaleElementReferenceException.class);
        LOGGER.info("Waiting on expected condition, using timeout of " + waitSeconds + " seconds");
    ...
    public <T extends TopLevelPage> T waitOnPagePredicateWithRefresh(final Predicate<T> predicate, final Class<T> pageClass, String message, TimeoutType timeout) {
        ...
        LOGGER.info("Waiting on Predicate for page " + pageClass.getSimpleName() + ", using timeout of " + timeoutSeconds + " seconds");
    ...
    public <T> void waitOnPredicate(Predicate<T> predicate, T input, String message, TimeoutType timeout) {
        ...
        FluentWait<T> fluentWait = new FluentWait<T>(input)
            ...
            .ignoring(NotFoundException.class)
            .ignoring(StaleElementReferenceException.class);
        fluentWait.until((T predInput) -> (predicate.apply(input)));
    }
    ...
    public <T> void waitOnPredicateWithRefresh(final Predicate<T> predicate, final T input, String message, TimeoutType timeout) {
        ...
        LOGGER.info("Waiting on expected condition, using timeout of " + waitSeconds + " seconds");
        wait.until((WebDriver webDriver) -> (predicate.apply(input)));
    }
    ...
    public WebElement waitUntilClickable(By locator, TimeoutType timeout) {
        ...
        wait.withMessage(errorMessage)
            .ignoring(StaleElementReferenceException.class);
        LOGGER.info("Waiting for locator element '" + locator + "' to be clickable, using timeout of " + waitSeconds + " seconds");
    ...
    private <T> T waitOnExpectedConditionForSeconds(ExpectedCondition<T> expectedCondition, String message, int timeout) {
        ...
        wait.withMessage(message)
            .ignoring(StaleElementReferenceException.class);
        LOGGER.info("Waiting on expected condition, using timeout of " + timeout + " seconds");
        return wait.until(expectedCondition);
    }
